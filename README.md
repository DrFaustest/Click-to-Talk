...
**[View Project Demo Video](https://youtu.be/ZgICXJpQtHA?si=jD4bxAExTHA62veB)** - See voice-controlled mouse navigation, command parsing, and accessibility features in real-time.
